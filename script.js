...
function showTab(status){
    ...
    // পরে Google Sheet/AppSheet থেকে
    // status অনুযায়ী Job Card দেখাবে

}

function acceptJob(jobId){

    // পরে Job Status = Running

}

function completeJob(jobId){

    // পরে Job Status = Completed

}

function viewDetails(jobId){

    // পরে Job Details খুলবে
